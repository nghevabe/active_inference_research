...
agent_model_base = extend_action_space("ACN1")
agent_model_base = extend_action_space("ACN2")

# Agent model: fixed internal belief
# rho = 0 means no noise, equivalent to using the base model directly.
agent_model = build_noisy_agent_b_from_env(
    env_model=agent_model_base,
    rho=0,
    seed=42,
)
