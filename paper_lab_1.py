...
# print(get_ates_positive_point("ACN2", "Neutral", "Comfortable", agent_model, 70, 30))
# print("XXX_ates_dif: ")
# print(ates_positive_update("ACN2", "Neutral", "Comfortable", agent_model, 70, 30))
# print("XXX_prob_new: ")
# ates_point = get_ates_positive_point("ACN2", "Neutral", "Comfortable", agent_model, 70, 30)
# ates_dif = ates_positive_update("ACN2", "Neutral", "Comfortable", agent_model, 70, 30)
# new_model = ates_update_matrix_positive("ACN2", "Neutral", "Comfortable", agent_model, ates_dif, ates_point)
